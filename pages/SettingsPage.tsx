                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        className="w-full bg-surface border border-secondary rounded-lg pl-7 pr-3 py-2.5 focus:ring-primary focus:border-primary focus:outline-none"
                                    />
                                </div>
                            </div>
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full bg-surface border border-secondary rounded-lg px-3 py-2.5 focus:ring-primary focus:border-primary focus:outline-none"
                                />
                            </div>
                            <div>
                                <label
                ...
                {activeTab === 'appearance' && (
                    <div className="space-y-6 bg-surface p-6 rounded-lg">
                        ...
                        <p className="text-sm text-text-secondary">
                            Choose how SuiCollect looks to you. Select a theme
                            preference.
                        </p>
                        <div className="flex space-x-4">
                            <button
                                onClick={toggleTheme}
                                className={`flex items-center justify-center w-32 h-20 rounded-lg border-2 ${
                                    theme === 'light'
                                        ? 'border-primary'
                                        : 'border-transparent'
                                }`}
                            ...
                            <button
                                onClick={toggleTheme}
                                className={`flex items-center justify-center w-32 h-20 rounded-lg border-2 bg-gray-800 ${
                                    theme === 'dark'
                                        ? 'border-primary'
                                        : 'border-transparent'
                                }`}
